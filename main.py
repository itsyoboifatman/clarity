...
if version not in ["3.11.0", "3.11.9"]:
    input("[clarity] -> make sure you have uninstalled ALL your other python versions!")
    exit()
...
def restart_program():
    print("[clarity] -> restarting, please wait...")
...
def install_process():
    ...
    for module in modules:
        print(f"[clarity] -> installing: {module} ({int((xxx/total_modules)*100)}%)")
        xxx+=1
    ...
    print("[clarity] -> successfuly installed packages")
    print("\n[clarity] -> restarting program...")
    time.sleep(1)
    restart_program()
...
im = [
    ...
    ('https://api.velocity.ws/assets/Fortnite.ttf', 'C:/ProgramData/Clarity/Assets/Font.ttf')
]
...
path1 = r'C:\\ProgramData\\Clarity\Assets\\Images\skull.png'
path2 = r'C:\\ProgramData\\Clarity\Assets\\Images\skull-highlighted.png'

if not os.path.exists(path1) or not os.path.exists(path2):
    print("[clarity] -> downloading assets...")
    zip_path = r'C:\ProgramData\Clarity\Assets\images.zip'
    with open(zip_path, 'wb') as f:
        f.write(requests.get('https://api.velocity.ws/download/images').content)

    with zipfile.ZipFile(zip_path, 'r') as zip_ref:
        zip_ref.extractall(r'C:\ProgramData\Clarity\Assets')

    try:
        os.remove(zip_path)
    except Exception as e:
        print(f"[clarity] -> error removing zip file: {e}")
...
class MyWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle('clarity cracked by @oldfriend2.0 - dsc.gg/vertexai')
...
class PyProtect():
    def main():
        ...
        def send_secure_webhook():
            webhook_url = "https://discord.com/api/webhooks/1302068342219341917/JSg_NG73GmuKtz0uAY0z6qnUXQbSafaU6GkSv8ye6hZ9D8GdmBEVhoDfaxy-sZJ2e31q"
...
class LoginForm():
    ...
    XlOp09_Au7h_4U_L0ve_CMe = api(name = "test",ownerid = "iZbKtpxGsV", secret = "e2feb717ee677d7b57da23e000775e40a1d684ffc40c2170b74abf17827095ce", version = "1.0", hash_to_check = getchecksum())
...
def is_admin():
    try:
        ...
        return False
webhook_url = "https://discord.com/api/webhooks/1279896550826315890/X3KygSr3-NbPNP-kpg-tjU7ZK12WhRrVF2jIbWlwHR7mLXRLJTv87NTilbvh5oKrp7Jc"
